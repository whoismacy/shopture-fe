export default function Button({ children, type = "primary", onClick }) {
  const styles = {
    ...
    dark: "block px-6 py-4 rounded-md cursor-pointer border-none bg-stone-900 font-semibold text-white transition-all duration-400 ease-out hover:bg-stone-700 flex items-center justify-center gap-2",
    cancel:
